...
echo "CREATE DATABASE clairtest WITH OWNER = postgres ENCODING = 'UTF8';"| /opt/rh/rh-postgresql96/root/usr/bin/psql -h "$POSTGRES_PORT_5432_TCP_ADDR" -p  "$POSTGRES_PORT_5432_TCP_PORT" -U postgres
#echo "CREATE DATABASE clairtest WITH OWNER = postgres ENCODING = 'UTF8';"| /opt/rh/rh-postgresql96/root/usr/bin/psql -h "$POSTGRES_PORT_5432_TCP_ADDR" -p  "$POSTGRES_PORT_5432_TCP_PORT" -U postgres
